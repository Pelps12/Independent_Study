...
## Clock Signals
set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS33} [get_ports s_clk]
create_clock -period 83.333 -name sys_clk_pin -waveform {0.000 41.667} -add [get_ports s_clk]
set_property -dict {PACKAGE_PIN R2 IOSTANDARD SSTL135} [get_ports axi_clk]
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports axi_clk]
...
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets l_OBUF_inst_i_4_n_0]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets l_OBUF_inst_i_10_n_0]
## Switches
#set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { d }]; #IO_L20N_T3_A19_15 Sch=sw[0]
#set_property -dict { PACKAGE_PIN H18   IOSTANDARD LVCMOS33 } [get_ports { c }]; #IO_L21P_T3_DQS_15 Sch=sw[1]
#set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { b }]; #IO_L21N_T3_DQS_A18_15 Sch=sw[2]
#set_property -dict { PACKAGE_PIN M5    IOSTANDARD SSTL135 } [get_ports { rst }]; #IO_L6N_T0_VREF_34 Sch=sw[3]

## RGB LEDs
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { p_state_correct }]; #IO_L23N_T3_FWE_B_15 Sch=led0_r
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports correct_instruction_flag]
#set_property -dict { PACKAGE_PIN F15   IOSTANDARD LVCMOS33 } [get_ports { led0_b }]; #IO_L13N_T2_MRCC_15 Sch=led0_b
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33} [get_ports iic2intc_irpt_0]
...
## LEDs
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { correct_instruction_flag }]; #IO_L16N_T2_A27_15 Sch=led[2]
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS33} [get_ports p_state_correct]
set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS33} [get_ports int_flag_out]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports int_flag]

## Buttons
#set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { hash }]; #IO_L18N_T2_A23_15 Sch=btn[0]
#set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { d }]; #IO_L19P_T3_A22_15 Sch=btn[1]
#set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { b }]; #IO_L19N_T3_A21_VREF_15 Sch=btn[2]
...
#set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { correct_instruction_flag }]; #IO_L24P_T3_A01_D17_14        Sch=jd10/ck_io[26]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports if_flag]
set_property -dict {PACKAGE_PIN R11 IOSTANDARD LVCMOS33} [get_ports clk_out]
#set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { int_pulse }]; #IO_L22N_T3_A04_D20_14        Sch=jd7/ck_io[29]
set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS33} [get_ports int_read]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports zero_valid]
...
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports gie]
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports counter_flag]
...
## ChipKit I2C
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports scl]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports sda]
